<%-- 
    ...
    Created on : 12-Sep-2023, 5:26:18 pm
    Author     : Kiran
--%>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
                <h2 class="text-white">Customer Login</h2>
                <div class="login-container">
                    <form class="login-form" action="CustomerLoginAction.jsp" method="post" name="myform" onsubmit="return validateuser(this);">
                        <table>
                            <tr>
                        ...
                        <p class="register-link">Don't have an account? <a href="customerRegister.jsp"><b>Register</b></a></p>
                    </form>
                </div>
            </div>
          </div>
