<%-- 
    ...
    Created on : 23-Sep-2023, 1:25:46 pm
    Author     : Kiran
--%>
<%@page import="com.bookMyCar.admin.getAcceptBooking"%>
<%@page import="com.bookMyCar.admin.FeedBackCount"%>
                  ...
                  <div class="pcoded-content">
                      ...
                      while(resultSet.next()){
                          users++;
                           ...
                           ResultSet result=new OwnerLogin().viewCars();
                           int cars=0;
                           while(result.next()){
                           cars++;
                          }
                           ResultSet Set=OwnerApplications.getOwners();
                          int Owner=0;
                           while(Set.next()){
                          Owner++;
                          }
                          ResultSet rs=FeedBackCount.getFeedback();
                          int feedback=0;
                          while(rs.next()){
                          feedback++;
                          }
                          ResultSet r=getAcceptBooking.getBookings();
                          int amount=0;
                          while(r.next()){
                         amount+=Integer.parseInt(r.getString("Amount"));
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-purple"><%=Owner%></h4>
                                                                <h6 class="text-muted m-b-0">Owners</h6>
                                                            </div>
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Total Owners</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green"><%=users%></h4>
                                                    ...
                                                    <div class="card-footer bg-c-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Total Customers</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-red"><%=cars%></h4>
                                                                <h6 class="text-muted m-b-0">Cars</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-footer bg-c-red">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Total Cars</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-blue"><%=feedback%></h4>
                                                    ...
                                                    <div class="card-footer bg-c-blue">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Total Feedback</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <span class="text-muted">amCharts.</span>
                                           ...
                                           <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green"><%=amount%></h4>
                                                    ...
                                                    <div class="card-footer bg-c-green">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Total Amount</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-line-chart text-white f-16"></i>
                                                            </div>
