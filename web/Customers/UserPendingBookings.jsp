            ...
            <div class="row no-gutters  f  align-items-end justify-content-start">
                <div class="col-md-6 ftco-animate pb-1">
                    <p class="breadcrumbs">
                        ...
                        <span>My Pending Bookings <i class="ion-ios-arrow-forward"></i></span>
                    </p>
					...
					<div class="container">
					  ...
					  <div class="collapse navbar-collapse" id="ftco-nav">
						<ul class="navbar-nav ml-auto">
						  ...
						  <li class="nav-item  active"><a href="UserPendingBookings.jsp" class="nav-link">Pending</a></li>
