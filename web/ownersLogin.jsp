<%-- 
    Document   : ownersLogin
    Created on : 12-Sep-2023, 5:38:09 pm
    Author     : Kiran
--%>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
                <h2 class="text-white">Owner Login</h2>
                <div class="login-container">
                    <form class="login-form" action="OwnerLoginAction.jsp" method="post" name="myform" onsubmit="return validateuser(this);">
                        <table>
                            <tr>
                        ...
                        <p class="register-link">Don't have an account? <a href="ownerRegister.jsp"><b>Register</b></a></p>
                    </form>
                </div>
            </div>
          </div>
 ...
 %>
  ...
  <div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px"><circle class="path-bg" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke="#eeeeee"/><circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="10" stroke="#F96D00"/></svg></div>
   ...
   <script>
        ...
        var successMessage = '${sessionScope.status}';
        if (successMessage !== '') {
     ...
     <script>
        // Check if the "success" attribute is present in the session
        var successMessage = '${sessionScope.status1}';
        if (successMessage !== '') {
            // Display SweetAlert with the success message
            Swal.fire({
                icon: 'error',
