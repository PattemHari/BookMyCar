<%-- 
    Document   : Admin_ViewBookings
    Created on : 21-Sep-2023, 8:09:47 pm
    Author     : Kiran
--%>
...
<%@page import="com.bookMyCar.admin.getAcceptBooking"%>
              ...
              <div class="pcoded-wrapper">
                  <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li >
                                <a href="Admin_ViewCars.jsps" class="waves-effect waves-dark">
                  ...
                  <div class="pcoded-content">
                      ...
                      <table border="1">
                          ...
                          ResultSet resultSet=getAcceptBooking.getBookings();
                          while(resultSet.next()){
                          Beans setter=new Beans();
                          setter.setEmail(resultSet.getString("OwnerEmail"));
                          setter.setName(resultSet.getString("carName"));
                          ResultSet result=new OwnerLogin().getOwner(setter);
                         if(result.next()){
                          ResultSet rs=new OwnerLogin().viewCar(setter);
                          
                          if(rs.next()){
                          %>
                          <tr>
                              
                              <td><%=rs.getString("licence")%></td>
