<%-- 
    ...
    Created on : 12-Sep-2023, 5:14:09 pm
    Author     : Kiran
--%>
      ...
      var password=form.password.value;
       var cpassword=form.cpassword.value;
        ...
        if(mobile.length!==10){
             Swal.fire({
                icon: 'error',
                title: 'It must contain 10 digits!',
                confirmButtonText: 'OK'
            }); 
            return false;
        }
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active "><a href="CustomerLogin.jsp" class="nav-link">Customer</a></li>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-12 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
                <h2 class="text-white">Customer Registation</h2>
                <!-- ... Your existing code ... -->

<div class="login-container">
<form class="login-form" action="CustomerRegisterAction.jsp" class="row" method="post" name="myform" onsubmit="return validateuser(this);" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <td colspan="4" class="text-white">Already have an account? <a href="CustomerLogin.jsp"><b>LOGIN</b></a></td>
            </tr>
        </table>
    </form>
</div>
...
<!-- ... Your existing code ... -->
    ...
    <script>
        ...
        var successMessage = '${sessionScope.customer}';
        if (successMessage !== '') {
