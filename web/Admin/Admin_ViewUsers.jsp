<%-- 
    Document   : Admin_ViewUsers
    Created on : 15-Sep-2023, 12:17:25 pm
    Author     : Kiran
--%>
              ...
              <div class="pcoded-wrapper">
                  ...
                  <div class="pcoded-content">
                      ...
                      <table border="1">
                          ...
                          <%
                          ResultSet resultSet=AdminLogin.viewUsers();
                          ...
                          <tr>
                            <td>
                              ...
                              <td> <img src='data:image/jpeg;base64,<%=ImageString.getImage(resultSet.getBlob("license"))%>' height="80px" width="80px" alt="Image" class="myImage" data-modal-id="myModal<%= count %>">
                                         </td>
